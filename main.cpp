...
const char *WINDOWTITLE = { "Final Project -- Xingyu Fan" };
...
Display( )
{
    ...
    else if (UFOSwitch == 1)
    {
        ...
        gluLookAt(-3, 7., (6.25 + (sin(2 * M_PI*Time) + 1) / 2 * 28.)*sin(2 * M_PI*Time), (6.25 + (sin(2 * M_PI*Time) + 1) / 2 * 28.) * cos(2 * M_PI*Time + M_PI / 3), 2., (6.25 + (sin(2 * M_PI*Time) + 1) / 2 * 28.) * sin(2 * M_PI*Time + M_PI / 3), sin(2 * M_PI*Time)*0.3, 1., 0.);
    ...
    if (WhichView == 1)
    {
        //UFO
        glPushMatrix();
        glTranslatef(-4, 4., (6.25 + (sin(2 * M_PI*Time) + 1) / 2 * 28.)*sin(2 * M_PI*Time));
    ...
    //UFO
    glPushMatrix();
    glTranslatef((6.25 + (sin(2 * M_PI*Time) + 1) / 2 * 28.)*sin(2 * M_PI*Time), 4., (6.25 + (sin(2 * M_PI*Time) + 1) / 2 * 28.)*sin(2 * M_PI*Time));
    glScaled(0.5, 0.5, 0.5);
    glCallList( DL );
    glPopMatrix();
    ...
    glEnable(GL_LIGHTING);
    glPushMatrix();
    glRotatef(360 * Time * sqrt(cude_cal(38.)) / sqrt(cude_cal(25.25)), 0., 1., 0.);
    glTranslatef(25.25, 0., 0.);
    SetMaterial(1.0, 1.0, 1.0, 2.);
    glCallList( HalleyList );
    glPopMatrix();
    glPopMatrix();
...
InitMenus( )
{
    ...
    int ufomenu = glutCreateMenu( DoOFUMenu );
    glutAddMenuEntry("Off", 0);
    glutAddMenuEntry("On", 1);
...
InitGraphics( )
{
    ...
    //Sun Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/sun2.bmp", &Width, &Height);
    ...
    //Mercury Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/mercurymap.bmp", &Width, &Height);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Venus Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/venusmap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Earth Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/earthmap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Moon Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/moonmap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Mars Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/marsmap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Jupiter Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/jupitermap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Saturn Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/saturnmap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Saturn Ring Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/saturnring.bmp", &Width, &Height);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Uranus Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/uranusmap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Uranus Ring Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/uranusring.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 64)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Neptune Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/neptunemap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //Pluto Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/plutomap.bmp", &Width, &Height);
    if (Texture == NULL || Width != 1024 || Height != 512)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    ...
    //Sky Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/space1.bmp", &Width, &Height);
    ...
    //Halley Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/velvetmap.bmp", &Width, &Height);
    ...
    glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
    glGenTextures(1, &HalleyTex);
    glBindTexture(GL_TEXTURE_2D, HalleyTex);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
    //UFO Texture
    Texture = BmpToTexture("/Users/xingyufan/Desktop/final/final/UFO.bmp", &Width, &Height);
    if (Texture == NULL || Width != 256 || Height != 256)
    {
        printf("Wrong Reading BMP File!");
        exit(1);
    }
    glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
    glGenTextures(1, &UFOTex);
...
InitLists( )
{
    ...
    glBindTexture(GL_TEXTURE_2D, UFOTex);
    LoadObjFile ("/Users/xingyufan/Desktop/final/final/UFO2.obj");
    ...
    glEndList( );
    //Halley
    HalleyList = glGenLists(1);
    glNewList(HalleyList, GL_COMPILE);
    glEnable(GL_TEXTURE_2D);
    glBindTexture(GL_TEXTURE_2D, HalleyTex);
    glColor3f(1., 1., 1.);
    MjbSphere(0.3, 100, 100);
    glDisable(GL_TEXTURE_2D);
    glEndList();
    //Mercury
